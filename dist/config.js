...
export default {
    ...
    commands: {
        unix: {
            ...
            deployService: "cd ${deployFolder} && git clone --depth 1 --single-branch --branch ${repoTag} ${repoUrl} ${serviceName} && cd ${serviceName} && npm ci --omit=dev",
            ...
            updateService: "cd ${deployFolder}/${serviceName} && git fetch --depth 1 origin ${repoTag} && git reset --hard FETCH_HEAD && npm ci --omit=dev",
